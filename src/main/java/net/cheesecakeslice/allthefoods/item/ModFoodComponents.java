...
public class ModFoodComponents {
    ...
    public static final FoodComponent BORSCHT = new FoodComponent.Builder().hunger(10).saturationModifier(1.2f).statusEffect(new StatusEffectInstance(StatusEffects.STRENGTH, 1000),100f).build();
}
